...
description: "Request and response contract for the Projects.ProjectJournal.SetupNewLine Bifröst message type."
---
...
## Overview
Creates one or more new project (job) journal lines in a batch, pre-populated by BC `SetUpNewLine`. Each line is assigned `Line No.` = last line + 10000 (or 10000 for an empty batch).
