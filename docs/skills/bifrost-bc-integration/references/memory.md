---
id: memory
title: "Company and user memory"
sidebar_label: "Company and user memory"
sidebar_position: 19
description: "Key-value storage inside Business Central, scoped either to the company or to the calling user. Use it to persist small amounts of integration state without adding a table."
---

Key-value storage inside Business Central, scoped either to the company or to the calling user. Use it to persist small amounts of integration state without adding a table.

[← back to SKILL.md](../index.md) · originally sections 7.9 of the single-file skill.
