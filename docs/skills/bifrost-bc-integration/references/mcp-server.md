---
id: mcp-server
title: "BC Metadata MCP server"
sidebar_label: "BC Metadata MCP server"
sidebar_position: 25
description: "The MCP server that exposes the same metadata and data over the Model Context Protocol: client configuration, the tools it offers, the integration timestamp and config helpers, server-side encryption, and how to use the metadata it returns in integration code."
---

The MCP server that exposes the same metadata and data over the Model Context Protocol: client configuration, the tools it offers, the integration timestamp and config helpers, server-side encryption, and how to use the metadata it returns in integration code.

[← back to SKILL.md](../index.md) · originally sections 23 of the single-file skill.
