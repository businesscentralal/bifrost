...
sidebar_position: 20
description: "Both directions of the webhook story: Webhook.Inbound.Receive for events pushed into Business Central and fanned out to subscribers, and the external business events Business Central raises when a Bifröst message completes or fails."
---
...
[← back to SKILL.md](../index.md) · originally sections 7.11, 13 of the single-file skill.
