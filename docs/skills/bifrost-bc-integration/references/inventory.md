...
sidebar_label: "Inventory and warehouse"
sidebar_position: 13
description: "The item journal and the physical document flow around it: transfer orders, assembly orders, warehouse shipments, picks, put-aways and receipts — each with its create, release, post and preview-post message types."
---
...
[← back to SKILL.md](../index.md) · originally sections 7.5c, 7.5c.1 – 7.5c.4 of the single-file skill.
