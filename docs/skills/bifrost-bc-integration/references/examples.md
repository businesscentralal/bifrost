...
sidebar_label: "Worked examples"
sidebar_position: 24
description: "Two end-to-end examples: creating a sales order header, lines and release through the generic data message types, and a small JavaScript/TypeScript helper that wraps the envelope, the polling and the error order."
---
...
[← back to SKILL.md](../index.md) · originally sections 12, 15 of the single-file skill.
