---
id: help-and-discovery
title: "Help and discovery"
sidebar_label: "Help and discovery"
sidebar_position: 5
description: "How an agent finds out what an environment actually offers before it calls anything: the Help.* message types (tables, fields, message types, implementation docs, permissions, next line number, page URLs, table relations, who am I) and the dynamic schema-discovery patterns built…"
---
...
[← back to SKILL.md](../index.md) · originally sections 7.2, 17 of the single-file skill.
