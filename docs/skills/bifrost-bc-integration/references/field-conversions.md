...
title: "Special field conversions and enums"
sidebar_label: "Special field conversions and enums"
sidebar_position: 9
description: "Field types whose JSON shape is not what a caller would guess — currency code, dimension set id, BLOB, Media and MediaSet — and how option and enum values are read and written."
---
...
[← back to SKILL.md](../index.md) · originally sections 9, 10 of the single-file skill.
