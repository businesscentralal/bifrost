---
id: lookups
title: "Reference data and lookups"
sidebar_label: "Reference data and lookups"
sidebar_position: 23
description: "The tables behind the dropdowns — countries, post codes, payment terms, posting groups and the rest — and the auto-fill chains a client is expected to reproduce."
---
...
[← back to SKILL.md](../index.md) · originally sections 21 of the single-file skill.
