---
id: notifications
title: "Notifications and email drafts"
sidebar_label: "Notifications and email drafts"
sidebar_position: 18
description: "Counting, reading, sending and marking notifications, retrieving a whole notification thread, and creating an email draft in the outbox without sending it."
---
...
[← back to SKILL.md](../index.md) · originally sections 7.10 of the single-file skill.
