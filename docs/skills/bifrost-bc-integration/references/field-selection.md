...
sidebar_label: "Selecting only the fields you need"
sidebar_position: 8
description: "Why fieldNumbers is not optional in practice, patterns for declaring field lists as constants, loading records and field metadata in parallel, building a form from metadata, and the JSON shape of the three binary field types on read and on write."
---
...
[← back to SKILL.md](../index.md) · originally sections 18 of the single-file skill.
