---
id: sales
title: "Sales, customers and items"
sidebar_label: "Sales, customers and items"
sidebar_position: 10
description: "Message types for the sales side: credit limit and sales history, customer statements, item availability and prices, creating, releasing, posting and previewing sales documents, PDF retrieval, payment application, quote and blanket-order conversion, correcting, cancelling and…"
---
...
[← back to SKILL.md](../index.md) · originally sections 7.3 of the single-file skill.
