---
id: changelog-guard
title: "Change Log and the Write Guard"
sidebar_label: "Change Log and the Write Guard"
sidebar_position: 17
description: "Reading a field’s modification history, restoring a previous value, checking whether a field is tracked at all, listing the records that changed in a time window, and the three modes of the ChangeLog Write Guard that decide whether a write is allowed through at all."
---
...
[← back to SKILL.md](../index.md) · originally sections 7.6 of the single-file skill.
