...
id: queue-api
title: "The queue API"
sidebar_label: "The queue API"
sidebar_position: 1
description: "What the Bifröst API is and how a call is made: the three endpoints (/tasks synchronous, /queues asynchronous, /responses({id})/data for results), reading back the original request, listing message history, polling, retrying and cancelling a queued message, and the exact shape…"
---
...
[← back to SKILL.md](../index.md) · originally sections 1, 3, 3b, 4 of the single-file skill.
