...
sidebar_position: 9
description: "Message types added to the Bifröst API by Bifrost Nornir. Job Queue scheduling, monitoring and restart for Business Central, plus declarative playbooks that chain Bifröst message types. Load alongside bifrost-bc-integration, which carries the API itself; this skill is the index…"
---
