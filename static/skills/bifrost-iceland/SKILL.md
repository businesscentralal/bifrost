---
name: bifrost-iceland
description: >
  Message types added to the Bifröst API by Bifrost Iceland. Icelandic government services and
  SMS gateways as Bifröst message types: Þjóðskrá through Umsjá, Skatturinn, Seðlabanki,
  Skilagrein, island.is and Já Gagnatorg. Load alongside bifrost-bc-integration, which carries
  the API itself; this skill is the index of what Iceland adds — 75 message types across 4
  families (Iceland.*, Ja.*, Finance.*, Help.*).
license: MIT
metadata:
  version: 1.0.0
  updated: 2026-09-06
