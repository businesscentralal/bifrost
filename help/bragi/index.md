...
| Page | Description |
| --- | --- |
| [Bifröst Bragi Setup](/help/bragi/bragi-setup/) | The app setup page, opened from the Apps group on Bifröst Setup: language models, the MCP tool server and the provider API keys. |
...
| [Bifrost Language Models](/help/bragi/bifrost-lang-model-list/) | List of all defined language models, opened from the Language Models action on Bifröst Bragi Setup. |
...
2.  Open **Bifrost Setup**, choose **Bifrost Bragi Setup** in the **Apps** group, then choose **Language Models** and create a language model with a chat provider and a skill.
