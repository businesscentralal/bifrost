---
id: index
title: "Bifröst Clockify — Help"
sidebar_label: "Bifröst Clockify — Help"
sidebar_position: 1
slug: /
---

**Bifröst Clockify** is the Clockify connector of the Bifröst platform, a Business Central extension by Origo. It exposes the Clockify time-tracking REST API as Bifröst message types, so external systems get direct read and write access to Clockify workspaces, clients, projects, tasks, tags and time entries through the Bifröst API.
...
| Page | Description |
| --- | --- |
| [Clockify Setup](/help/clockify/clockify-setup/) | The connector's setup card: API key, default workspace, Job Journal target, webhooks and the navigation to the lists. |
| [Enter Clockify API Key](/help/clockify/clockify-set-secret-dialog/) | Masked dialog for entering the Clockify API key. |
| [Clockify Workspaces](/help/clockify/clockify-workspace-lookup/) | Lookup of the workspaces the stored API key can reach, used to pick the default workspace. |
| [Clockify Integration](/help/clockify/clockify-integration-list/) | The links between Business Central records and Clockify objects. |
| [Clockify Webhooks](/help/clockify/clockify-webhooks/) | The Clockify webhooks this company has registered for real-time time-entry sync. |
...
2.  Open [Clockify Setup](/help/clockify/clockify-setup/) — the **Clockify** action in the **Apps** group of the Bifröst **Setup** page.
3.  Choose **Set Company API Key** and paste the key into the [masked dialog](/help/clockify/clockify-set-secret-dialog/).
4.  Look up **Default Workspace** and pick a workspace from the [workspace list](/help/clockify/clockify-workspace-lookup/).
