...
The **Playbook Execution Log** lists every playbook run, newest first. It is read-only and is the starting point when a scheduled playbook has to be investigated. Select a line to open the [Playbook Execution Detail](/help/orchestrator/playbook-instance-card/) card with the step-by-step log.
