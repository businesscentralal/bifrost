...
-   Reference the credential pair from an orchestrator entry through the **Client Credentials Code** field on the [entry card](/help/orchestrator/scheduled-entry-card/).
