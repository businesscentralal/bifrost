...
company, day and pool. Open it from **License Usage** on the [Bifrost Setup](/help/foundation/bifrost-setup/)
...
| **License Type Filter** | **User** or **App Registration**; leave it empty for both pools. |
...
| **License Type** | The pool that was charged. |
