...
| **4\. Setup Complete** | Confirms that setup is done. Every setting can be changed later on the [Job Queue Orchestrator Setup](/help/nornir/scheduler-setup/) page, which is reached from Bifrost Setup. |
...
| **Open Orchestrator Setup** | Opens the [Job Queue Orchestrator Setup](/help/nornir/scheduler-setup/) page for detailed configuration. |
