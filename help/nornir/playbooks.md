...
This list shows every playbook defined in the company together with the outcome of its most recent run. Select a line to open the [Bifrost Playbook](/help/nornir/playbook-card/) card.
...
| Action | Description |
| --- | --- |
| **Execution Log** | Opens the [Playbook Execution Log](/help/nornir/playbook-instances/) filtered to the selected playbook. |
