...
A **Job Queue Recurring Template** describes one reusable schedule. When an [orchestrator entry](/help/nornir/scheduled-entry-card/) or a [scheduled playbook](/help/nornir/schedule-playbook/) refers to a template, the entry follows the template instead of its own recurrence fields.
