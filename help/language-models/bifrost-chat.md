...
| **A language model** | At least one record on [Bifrost Language Models](/help/language-models/bifrost-lang-model-list/) must be configured and usable, either marked as **Default** or assigned to the user on User Setup. |
