...
| **Kóði auðkenna biðlara** | [Auðkenni biðlara](/help/nornir/credentials-list/) sem notað eru þegar þessi færsla kallar í ytri þjónustu. |
| **Fyrsti tími til keyrslu** | Fyrsta dagsetning og tími sem verkið má keyra. |
| **Endurtekningarsniðmát** | [Endurtekningarsniðmát](/help/nornir/recurring-template/) sem gefur áætlunina. Þegar sniðmát er valið verða reitirnir í endurtekningarhlutanum óbreytanlegir og fylgja sniðmátinu. |
...
| **Vinnsluraðafærsla** | Opnar [Spjald vinnsluraðafærslu](/help/nornir/job-queue-entry-card/) fyrir undirliggjandi vinnsluraðafærslu. Aðeins virkt meðan slík færsla er til. |
