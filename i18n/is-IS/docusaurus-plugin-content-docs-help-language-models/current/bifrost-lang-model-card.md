...
-   [Bifröst mállíkan](/help/language-models/bifrost-lang-model-list/) – Listi yfir öll mállíkön
-   [Spjalla við Bifröst og notandauppsetning](/help/language-models/bifrost-chat/) – Tengja mállíkan við notanda
