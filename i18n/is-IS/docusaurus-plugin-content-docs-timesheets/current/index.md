...
Bifröst Timesheets tengir Business Central við [Clockify](https://clockify.me), þjónustu fyrir tímaskráningu. Hún byggir á Bifröst Foundation og birtir Clockify REST-viðmótið sem 41 skilaboðategund, svo ytra kerfi, MCP-biðlari eða ferli í Business Central geti lesið og skrifað Clockify-gögn gegnum sama biðraðar-, verk- og gagnamynstur og aðrar einingar Bifrastar nota. Ofan á þá beinu miðlun færir tengingin loknar Clockify-tímafærslur inn í Business Central sem verkbókarlínur eða tímablaðsfærslur, og stýrir lífsferli tímablaðanna.
...
- [Hjálp í kerfinu](/help/timesheets/)
