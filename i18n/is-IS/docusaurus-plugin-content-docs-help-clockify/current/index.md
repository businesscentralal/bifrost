...
| Síða | Lýsing |
| --- | --- |
| [Uppsetning Clockify](/help/clockify/clockify-setup/) | Uppsetningarspjald tengingarinnar: API lykill, sjálfgefið vinnusvæði, verkbók, vefkrókar og leiðin að listunum. |
| [Slá inn Clockify API lykil](/help/clockify/clockify-set-secret-dialog/) | Falinn gluggi til að slá inn Clockify API lykilinn. |
| [Clockify vinnusvæði](/help/clockify/clockify-workspace-lookup/) | Uppfletting á vinnusvæðunum sem geymdi API lykillinn nær til, notuð til að velja sjálfgefið vinnusvæði. |
| [Clockify tengingar](/help/clockify/clockify-integration-list/) | Tengingarnar milli BC-færslna og Clockify-hluta. |
| [Clockify vefkrókar](/help/clockify/clockify-webhooks/) | Clockify-vefkrókarnir sem þetta fyrirtæki hefur skráð fyrir rauntímasamstillingu tímafærslna. |
...
2.  Opnaðu [Uppsetningu Clockify](/help/clockify/clockify-setup/) — aðgerðina **Clockify** í flokknum **Forrit** á **Uppsetningarsíðu** Bifrastar.
3.  Veldu **Skrá API lykil fyrirtækis** og límdu lykilinn inn í [falda gluggann](/help/clockify/clockify-set-secret-dialog/).
4.  Flettu upp **Sjálfgefnu vinnusvæði** og veldu vinnusvæði úr [vinnusvæðalistanum](/help/clockify/clockify-workspace-lookup/).
