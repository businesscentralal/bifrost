---
id: timesheets-set-secret-dialog
...
Keyrðu aðgerðina aftur til að skrifa yfir geymda lykilinn; ekki þarf að eyða honum fyrst. Til að fjarlægja hann alveg skaltu nota **Eyða API lykli fyrirtækis** á [Uppsetningu Clockify](/help/timesheets/timesheets-setup/). Sé enginn lykill geymdur svarar hver skilaboðategund sem kallar á Clockify með meðhöndlaðri villu um að lykilinn vanti, í stað þess að bregðast.
