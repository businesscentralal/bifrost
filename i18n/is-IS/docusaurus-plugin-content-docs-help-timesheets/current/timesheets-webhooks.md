...
Síðan er einungis til lestrar. Vefkrókar eru stofnaðir og fjarlægðir með aðgerðunum **Skrá vefkróka** og **Fjarlægja vefkróka** á [Uppsetningu Clockify](/help/timesheets/timesheets-setup/), og listinn er opnaður með aðgerðinni **Skráðir vefkrókar** á sama spjaldi.
