...
**Clockify vinnusvæði** er uppflettigluggi sem sýnir þau Clockify-vinnusvæði sem geymdi API lykill fyrirtækisins nær til. Hann opnast úr reitnum **Sjálfgefið vinnusvæði** á [Uppsetningu Clockify](/help/timesheets/timesheets-setup/); þegar lína er valin eru bæði auðkenni vinnusvæðisins og heiti þess skrifuð á uppsetningarspjaldið.
...
- **Enginn lykill geymdur** — uppflettingin þarf API lykil fyrirtækisins. Skráðu hann fyrst með **Skrá API lykil fyrirtækis** á [Uppsetningu Clockify](/help/timesheets/timesheets-setup/).
