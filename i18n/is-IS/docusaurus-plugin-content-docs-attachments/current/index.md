...
Bifröst Attachments tengir Business Central við skýgeymslu. Hún byggir á Bifröst Foundation og birtir staðlaða ytri skráageymslutengla Business Central — Azure Blob Storage, Azure File Share og SharePoint — sem skilaboðategundir, svo ytra kerfi, MCP-biðlari eða ferli í Business Central geti lesið og skrifað skrár gegnum sama biðraðar-, verk- og gagnamynstur og aðrar einingar Bifrastar nota.
...
- [Hjálp í kerfinu](/help/attachments/)
