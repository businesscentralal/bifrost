---
id: bragi-setup
title: "Uppsetning Bifröst Braga"
sidebar_label: "Uppsetning Braga"
sidebar_position: 5
---

**Uppsetning Bifröst Braga** er eina uppsetningarsíða spjalleiningarinnar. Hún er opnuð úr flokknum **Forrit** á **Uppsetningarsíðu** Bifrastar og sýnir í einu vetfangi hvort þrennt sem Bragi þarf sé til staðar: mállíkön, MCP verkfæraþjónninn og API-lyklar veitenda.
...
| Reitur | Lýsing |
| --- | --- |
| **Mállíkön** | Hversu mörg mállíkön eru sett upp í þessu fyrirtæki. Kafið niður til að opna [lista yfir mállíkön](/help/bragi/bifrost-lang-model-list/). |
...
Business Central heldur geymdum leyndarmálum aðskildum eftir viðbótum, svo lyklar sem voru skráðir í eldri útgáfu forritsins flytjast ekki með. Opnið mállíkan og notið **Skrá persónulegan API-lykil** eða **Skrá sameiginlegan API-lykil** á [spjaldi mállíkans](/help/bragi/bifrost-lang-model-card/) til að slá hvern lykil inn einu sinni. Til að skrá eða hreinsa sameiginlega lykilinn þarf heimildasettið `BIFROST ChatSvc ori`.

## Aðgerðir

| Aðgerð | Lýsing |
| --- | --- |
| **Mállíkön** | Opnar [lista yfir mállíkön](/help/bragi/bifrost-lang-model-list/). |
...
2.  Opnið **Uppsetningu Bifrastar**, veljið **Uppsetning Bifröst Braga** í flokknum **Forrit** og hreinsið HTTP-tilkynninguna ef hún birtist.
