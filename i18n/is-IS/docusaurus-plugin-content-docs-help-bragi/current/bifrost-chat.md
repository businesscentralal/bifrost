...
| **Mállíkan** | Að minnsta kosti eitt mállíkan á síðunni [Bifröst mállíkön](/help/bragi/bifrost-lang-model-list/) þarf að vera uppsett og nothæft, annað hvort merkt **Sjálfgefið** eða tengt notandanum í notandauppsetningu. |
...
-   [Bifröst mállíkön](/help/bragi/bifrost-lang-model-list/) – Listi yfir öll skilgreind mállíkön
-   [Mállíkansspjald](/help/bragi/bifrost-lang-model-card/) – Veitandi, líkanstillingar og hæfni
-   [Hjálp fyrir Bifrost Bragi](/help/bragi/) – Yfirlit yfir viðbótina
