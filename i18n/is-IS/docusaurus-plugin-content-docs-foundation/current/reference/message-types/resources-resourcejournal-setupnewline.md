...
description: "Beiðni- og svarsamningur fyrir Resources.ResourceJournal.SetupNewLine Bifröst skilaboðategund."
---
...
## Yfirlit
Býr til ein eða fleiri ný resource dagbók lines in a batch, pre-populated með BC `SetUpNewLine`. hver line er assigned `Line No.` = síðasta line + 10000 (eða 10000 fyrir an empty batch).
