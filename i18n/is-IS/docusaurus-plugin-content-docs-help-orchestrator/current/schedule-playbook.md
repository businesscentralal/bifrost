...
**Tímasetja keðju** er glugginn sem gerir keðju að tímasettu verki. Hann er opnaður með aðgerðinni **Tímasetja** á spjaldinu [Bifröst keðja](/help/orchestrator/playbook-card/) og býr til [vinnsluraðarafærslu](/help/orchestrator/scheduled-entry-card/) sem keyrir keðjuna samkvæmt völdu sniðmáti þegar staðfest er.

## Reitir

| Reitur | Lýsing |
| --- | --- |
| **Endurtekningarsniðmát** | [Endurtekningarsniðmátið](/help/orchestrator/recurring-templates/) sem gefur áætlunina. Skyldureitur – ekki er hægt að staðfesta gluggann án þess. |
...
-   Ef ekkert sniðmát hentar skaltu fyrst búa það til á [Endurtekningarsniðmát vinnsluraða](/help/orchestrator/recurring-templates/).
