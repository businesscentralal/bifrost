...
Bifröst Orchestrator birtir fáeinar API-síður undir útgefandanum `origo`, API-hópnum `jobQueueOrchestrator` og útgáfu `v1.0`. Þær eru notuðar af ytri samhæfingum og eru ekki opnaðar af notendum.
